const eventDomString = (eventArray) => {
  ...
  eventArray.forEach((event) => {
    strang +=   `<div class="col-md-3 event-card">`;
    ...
    strang +=     `<button type="button" class="deleteEvent btn btn-success btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</button>`;
